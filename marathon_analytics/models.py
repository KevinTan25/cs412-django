...
def load_data():
    ...
    filename = '/Users/kevintan/Downloads/2023_chicago_results.csv'
    f = open(filename)
    f.readline() # discard headers

    for line in f:
        fields = line.split(',') # create a list of fields separated by commas

        try:
            # line = f.readline().strip() # read a line for processing
            # fields = line.split(',') # create a list of fields separated by commas
