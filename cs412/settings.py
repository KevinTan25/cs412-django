...
SECRET_KEY = "django-insecure-%n^nannrz@*7qd@xc+9q_d9n)+-#+zz2jm@)dtv-q37-0_tfs3"
...
INSTALLED_APPS = [
    ...
    "blog", # Blog app
    "mini_fb", # Mini facebook app
    "marathon_analytics", # marathon app
    "voter_analytics", # voter app
]
